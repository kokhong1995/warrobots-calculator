...
import { applyUpgradeDiscountPercentage, applyUpgradeSpeedMultiplier, calculateTotalTitanDeployPoints } from '/warrobots-calculator/js/modifier-helper.js?v=1.6.1';
