import { toInt } from '/warrobots-calculator/js/data-helper.js?v=1.7.2';
import { resetInputs, updateNumberInput } from '/warrobots-calculator/js/input-helper.js?v=1.7.2';
import { applyUpgradeDiscountPercentage } from '/warrobots-calculator/js/modifier-helper.js?v=1.7.2';
...
function syncData() {
    ...
    for (i = 0; i < DS_DRONE_UPGRADES.length; i++) {
        ...
        // Total up quantity, microchips, and upgrade tokens.
        totalQuantity += quantity;
        totalMicrochips += microchips;
        totalUpgradeTokens += upgradeTokens;
    }

    // Set total quantity, total microchips and total upgrade tokens.
...
function resetModifiers() {
    resetInputs([
        '#inputDroneUpgradeDiscountPercentage'
    ], 0, syncData);
}
